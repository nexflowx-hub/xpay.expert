...
const gateways = ["xpay-expert", "stripe-rail", "adyen", "checkout", "wise"];
...
export const mockWallets: Wallet[] = [
  ...
  {
    id: "wlt_card", currency: "EUR", label: "XPay Card •4821", balance: 18420.0,
...
export const mockProducts: Product[] = [
  { id: "prod_1", name: "Pro Plan (Annual)", description: "Annual subscription to XPay Pro", price: 1188, currency: "EUR", active: true, sales: 342, createdAt: iso(120) },
...
export const mockStores: Store[] = [
  { id: "store_1", name: "Main Store", domain: "shop.xpay.expert", status: "active", products: 24, revenue: 1823400, currency: "EUR", createdAt: iso(200) },
  { id: "store_2", name: "EU Store", domain: "eu.xpay.expert", status: "active", products: 18, revenue: 940200, currency: "EUR", createdAt: iso(150) },
  { id: "store_3", name: "BR Store", domain: "brasil.xpay.expert", status: "active", products: 12, revenue: 1280000, currency: "BRL", createdAt: iso(120) },
  { id: "store_4", name: "Wholesale", domain: "wholesale.xpay.expert", status: "paused", products: 6, revenue: 320000, currency: "USD", createdAt: iso(80) },
];
...
export const mockPaymentLinks: PaymentLink[] = Array.from({ length: 8 }).map((_, i) => ({
  ...
  url: `pay.xpay.expert/l/${int(1000, 9999)}`,
...
export const sdkSnippets: Record<string, string> = {
  curl: `curl https://api.xpay.expert/api/v1/payments \\
  ...
  node: `import { XPay } from "@xpay-expert/node";

const xp = new XPay(process.env.XP_SECRET_KEY);
...
console.log(payment.id, payment.status);`,
  python: `import xpay-expert

xp = xpay-expert.Client(api_key="xp_live_...")
...
$xp = new XPay\\Client(getenv('XP_SECRET_KEY'));
...
import (
    "context"
    "fmt"
    "github.com/xpay-expert/go-sdk/xp"
)
