...
// ---- Code snippets ----
const SNIPPET_S2S_MBWAY = `curl -X POST https://api.xpay.expert/api/v1/payments/charge \\
  -H "Content-Type: application/json" \\
  -H "x-api-key: sk_test_xpay-expert_v3" \\
  -d '{
    "amount": 1400,
    "currency": "EUR",
...
const SNIPPET_S2S_MULTIBANCO = `curl -X POST https://api.xpay.expert/api/v1/payments/charge \\
  -H "Content-Type: application/json" \\
  -H "x-api-key: sk_test_xpay-expert_v3" \\
  -d '{
    "amount": 3450,
    ...
    "customer": { "email": "dev@xpay.expert" }
  }'`;

const SNIPPET_CHECKOUT = `curl -X POST https://api.xpay.expert/api/v1/checkout/session \\
  -H "Content-Type: application/json" \\
  -H "x-api-key: sk_test_xpay-expert_v3" \\
  -d '{
    "amount": 2510,
    ...
    "customer": { "email": "test@xpay.expert" }
  }'`;
            ...
            <Card className="border-border/60 bg-card/60 p-4 backdrop-blur-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <code className="text-sm text-primary">https://api.xpay.expert/api/v1</code>
                </div>
              </div>
            </Card>
          </DocSection>
            ...
            <div className="flex items-start gap-3 rounded-lg border border-sky-500/25 bg-sky-500/8 px-4 py-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  ...
                  <code className="rounded bg-black/40 px-1.5 py-0.5 font-mono text-xs text-amber-300">sk_test_xpay-expert_v3</code>
                </p>
              </div>
            </div>
          </DocSection>
            ...
            <div className="relative overflow-hidden rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-transparent p-6">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  <code className="rounded bg-black/40 px-2 py-0.5 font-mono text-sm text-amber-300">sk_test_xpay-expert_v3</code>
        ...
        <Card className="border-border/60 bg-card/60 p-6 backdrop-blur-xl">
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <Button variant="outline" size="sm" className="gap-1.5" onClick={() => window.open("https://t.me/XPay_Manager", "_blank")}>
