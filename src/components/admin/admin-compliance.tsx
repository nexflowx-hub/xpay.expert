...
const AUDIT: AuditEvent[] = [
  { id: "aud_9201", actor: "admin@xpay.expert", action: "merchant.frozen", resource: "merch_8421 (Acme Pay)", ip: "10.4.2.18", timestamp: new Date(Date.now() - 1000 * 60 * 9).toISOString() },
  { id: "aud_9198", actor: "compliance@xpay.expert", action: "api_key.revoked", resource: "key_live_8821", ip: "10.4.2.51", timestamp: new Date(Date.now() - 1000 * 60 * 34).toISOString() },
  { id: "aud_9194", actor: "treasury@xpay.expert", action: "payout.approved", resource: "payout_22481 — €48,200.00", ip: "10.4.2.33", timestamp: new Date(Date.now() - 1000 * 60 * 72).toISOString() },
  { id: "aud_9191", actor: "admin@xpay.expert", action: "kyc.decision.approved", resource: "kyc_1042 (Nordic Retail AB)", ip: "10.4.2.18", timestamp: new Date(Date.now() - 1000 * 60 * 108).toISOString() },
  ...
  { id: "aud_9184", actor: "compliance@xpay.expert", action: "sanctions.blocked", resource: "scr_4821 (Aldo Petrov)", ip: "10.4.2.51", timestamp: new Date(Date.now() - 1000 * 60 * 192).toISOString() },
  { id: "aud_9180", actor: "admin@xpay.expert", action: "merchant.suspended", resource: "merch_3094 (Bolt Logistics)", ip: "10.4.2.18", timestamp: new Date(Date.now() - 1000 * 60 * 240).toISOString() },
  { id: "aud_9177", actor: "treasury@xpay.expert", action: "wallet.adjusted", resource: "wlt_eur_8821 — +€2,400.00", ip: "10.4.2.33", timestamp: new Date(Date.now() - 1000 * 60 * 318).toISOString() },
];
