...
const TEMPLATES: { level: LogLevel; service: string; message: string }[] = [
  ...
  { level: "info", service: "payments", message: "Authorization auth_{id} approved via xpay-expert rail" },
  ...
  { level: "debug", service: "payments", message: "Routing decision: xpay-expert (cost {cost}€, approval 97.8%) chosen over stripe" },
  ...
  { level: "error", service: "payments", message: "Gateway xpay-expert returned 502 for txn_{id} — failover to stripe initiated" },
